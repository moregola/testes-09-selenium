...
import java.net.URL;
public class REQ03CT03EdicaoAlteracaoExclusaoTest {
  ...
  @Test
  public void rEQ03CT03EdicaoAlteracaoExclusao() {
    ...
    vars.put("win4639", waitForWindow(2000));
    driver.switchTo().window(vars.get("win4639").toString());
    driver.findElement(By.cssSelector("tr:nth-child(4) .btn-primary")).click();
    driver.findElement(By.cssSelector(".container")).click();
    driver.findElement(By.id("nome")).sendKeys("ciclano atualizado");
